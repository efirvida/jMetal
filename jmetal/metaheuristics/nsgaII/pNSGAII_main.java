...
public class pNSGAII_main {
  ...
  ClassNotFoundException {
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_pNSGAII_VAR");
    population.printVariablesToFile(args[0]+"_pNSGAII_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_pNSGAII_FUN");
    population.printObjectivesToFile(args[0]+"_pNSGAII_FUN");
