...
public class MOEAD_main {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_MOEAD_VAR");
    population.printVariablesToFile(args[0]+"_MOEAD_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_MOEAD_FUN");
    population.printObjectivesToFile(args[0]+"_MOEAD_FUN");   
