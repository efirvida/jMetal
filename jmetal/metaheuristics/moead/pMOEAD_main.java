...
public class pMOEAD_main {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_pMOEAD_VAR");
    population.printVariablesToFile(args[0]+"_pMOEAD_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_pMOEAD_FUN");
    population.printObjectivesToFile(args[0]+"_pMOEAD_FUN");       
