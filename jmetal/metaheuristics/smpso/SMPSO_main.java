...
public class SMPSO_main {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_SMPSO_VAR");
    population.printVariablesToFile(args[0]+"_SMPSO_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_SMPSO_FUN");
    population.printObjectivesToFile(args[0]+"_SMPSO_FUN");    
