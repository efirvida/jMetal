...
public class SMPSOhv_main {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_SMPSOhv_VAR");
    population.printVariablesToFile(args[0]+"_SMPSOhv_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_SMPSOhv_FUN");
    population.printObjectivesToFile(args[0]+"_SMPSOhv_FUN");   
