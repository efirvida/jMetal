...
public class PSO_main {
  ...
  public static void main(String [] args) 
    ...
    if (args.length == 1) {
      ...
      logger_.info("Select problem to run from problems folder");
      return;
    } // else
    ...
    logger_.info("Objectives values have been writen to file "+args[0]+"_PSO_FUN");
    population.printObjectivesToFile(args[0]+"_PSO_FUN");
    logger_.info("Variables values have been writen to file "+args[0]+"_PSO_VAR");
    population.printVariablesToFile(args[0]+"_PSO_VAR");                         
  } //main
} // PSO_main
