...
public class pgGA_main {
  ...
  public static void main(String [] args) throws JMException, ClassNotFoundException {
    ...
    /* Log messages */
    System.out.println("Objectives values have been writen to file "+args[0]+"_GA_FUN");
    population.printObjectivesToFile(args[0]+"_GA_FUN");
    System.out.println("Variables values have been writen to file "+args[0]+"_GA_VAR");
    population.printVariablesToFile(args[0]+"_GA_VAR");          
  } //main
} // pgGA_main
