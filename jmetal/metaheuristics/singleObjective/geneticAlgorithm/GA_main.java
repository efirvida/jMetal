...
public class GA_main {
  ...
  public static void main(String [] args) throws JMException, ClassNotFoundException {
    ...
    //algorithm = new pgGA(problem) ;   // Asynchronous cGA
    ...
    */
    ...
    /* Log messages */
    System.out.println("Objectives values have been writen to file GA_FUN");
    population.printObjectivesToFile("GA_FUN");
    System.out.println("Variables values have been writen to file GA_VAR");
    population.printVariablesToFile("GA_VAR");          
  } //main
} // GA_main
