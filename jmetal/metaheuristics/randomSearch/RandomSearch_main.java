...
public class RandomSearch_main {
  ...
  public static void main(String [] args) throws
    ...
    logger_.info("Variables values have been writen to file "+args[0]+"_RandomSearch_VAR");
    population.printVariablesToFile(args[0]+"_RandomSearch_VAR");    
    logger_.info("Objectives values have been writen to file "+args[0]+"_RandomSearch_FUN");
    population.printObjectivesToFile(args[0]+"_RandomSearch_FUN");       
