...
package jmetal.problems.multiObjective;
 ...
 */
public class MO_Binh2 extends Problem{
  /**
   * Constructor
   * Creates a default instance of the MO_Binh2 problem
   * @param solutionType The solution type must "Real" or "BinaryReal".
   */
  public MO_Binh2(String solutionType) {
    numberOfVariables_  = 2;
    numberOfObjectives_ = 2;
    numberOfConstraints_= 2;
    problemName_        = "MO_Binh2";
